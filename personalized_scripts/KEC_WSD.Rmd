...
mapviewOptions(basemaps = c("OpenStreetMap","Esri.WorldImagery", "Esri.WorldShadedRelief"))
...
wells <- 
  read_csv("data/Water_Supply_Systems/data_sources/California/Mojave_Well_Completion_Reports.csv") %>%
  clean_names() %>%
